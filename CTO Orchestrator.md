...
**Auto-clarity — full sentences for:** security warnings, irreversible actions, multi-step sequences where fragment order risks misread.

**Lead with verdict.** First output = CTO execution plan. Never background first.
